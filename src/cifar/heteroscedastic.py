...
flags.DEFINE_integer(
    "num_factors", 2, "Num factors to approximate full rank covariance matrix."
)
flags.DEFINE_float("temperature", 1.3, "Temperature for heteroscedastic head.")
flags.DEFINE_integer(
    "num_mc_samples", 10000, "Num MC samples for heteroscedastic layer."
)
